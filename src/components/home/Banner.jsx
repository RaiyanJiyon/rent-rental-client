            ...
            <div className="hero-content text-white text-center relative z-20">
                <div className="md:w-4/5">
                    ...
                    <p className="mb-5 text-lg">
                        Whether you’re planning a weekend getaway, a business trip, or just need a <br /> reliable ride for the day, we offers a wide range of vehicles to suit your <br /> needs.
                    </p>
